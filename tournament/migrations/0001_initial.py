# Generated by Django 3.1 on 2020-10-05 15:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_per_kill', models.FloatField(blank=True, help_text='Price per kill')),
                ('winner_price', models.FloatField(blank=True, help_text='Price for winner at the end')),
                ('price_for_top_winners', models.FloatField(blank=True, help_text='Price for top players')),
            ],
        ),
        migrations.CreateModel(
            name='Tournament',
